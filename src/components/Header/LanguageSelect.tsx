...
const LanguageSelect: FunctionalComponent<{ lang: string }> = ({ lang }) => {
	return (
		<div className="language-select-wrapper flex items-center ">
			<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate relative" viewBox="0 0 16 16">
