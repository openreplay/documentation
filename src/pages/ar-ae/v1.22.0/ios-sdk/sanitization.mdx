...
يتم تصدير مفتاحين لاقتطاع بيانات الطلب/الاستجابة تلقائيًا: `ignoredKeys` للجسم و`ignoredHeaders` للترويسات. سيتم تنقية كلٍّ من الطلب والاستجابة، لكن الجسم لن يتأثر إلا إذا كان بصيغة JSON صالحة.
...
## هل لديك أسئلة؟
إذا كانت لديك أي أسئلة حول هذه العملية، فلا تتردد في التواصل معنا عبر [Slack](https://slack.openreplay.com) أو الاطّلاع على [المنتدى](https://forum.openreplay.com) الخاص بنا.
