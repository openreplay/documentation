---
title: "الأحداث"
metaTitle: "حزمة OpenReplay Analytics SDK — الأحداث"
metaDescription: "تعريف وإدارة الخصائص الفائقة لأحداث التحليلات الخاصة بمتعقّب OpenReplay."
---

## الأحداث

تتيح لك هذه الوحدة إدارة **الأحداث** و**الخصائص** — وهي أزواج مفتاح/قيمة دائمة تُرفَق تلقائيًا بكل حدث يتم تتبّعه.
...
تُمرَّر خصائص الحدث فقط لاستدعاء واحد لـ `track/sendEvent` و**لا تُحفَظ** كخصائص فائقة.
