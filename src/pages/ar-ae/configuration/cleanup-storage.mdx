...
إذا كنت تريد تنظيف جميع الجلسات، فانتقل إلى [الجزء التالي](#حذف-جميع-الجلسات) لأنه أسرع ويحرّر مساحة التخزين على الفور.
...
<Aside type="note">
	...
	إضافة إلى ذلك، ستتطلب بعض المساحة الحرة لكي تعمل، ولهذا نوصي بشدة بتشغيل هذه الاستعلامات بترتيب تصاعدي وفق [حجم الجداول](#التحقق-من-حجم-الجداول)
</Aside>
