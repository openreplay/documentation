...
- يجب أن يكون نظام التشغيل *Ubuntu Server 24.04 LTS*.
- الحد الأدنى لمواصفات الجهاز الذي يعمل بـ OpenReplay هو `2 vCPUs, 8 GB of RAM, 50 GB of storage`، على معمارية x86، وإلا فإن خدمات الخلفية لـ OpenReplay لن تبدأ ببساطة. يجب أن يكون هذا كافيًا لحجم منخفض/معتدل. إذا كنت تتوقع حركة مرور عالية، يجب أن تبدأ بالتوسع من هنا.
