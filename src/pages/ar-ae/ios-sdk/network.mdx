...
metaDescription: "تفاصيل حول اعتراض الشبكة لمتعقّب iOS"
---
...
يُصدَّر مفتاحان لتقليم بيانات الطلب/الاستجابة تلقائيًا: `ignoredKeys` للجسم و`ignoredHeaders` للترويسات. سيتم تنقية كلٍّ من الطلب والاستجابة، لكن الجسم لن يتأثر إلا إذا كان JSON صالحًا.
