...
<Aside type="tip">
بينما يمكنك الحصول على [نسخة مقتطف JS](/sdk/using-or/snippet#الحصول-على-المقتطف) من أداة التتبع الخاصة بنا مباشرةً من شبكة CDN عند إنشاء مشروع جديد، فإن هذا الكود أساسي للغاية وسيجعل من الصعب تخصيصه وإضافة إضافات (plugins) أخرى.
</Aside>
...
إذا كنت تبني تطبيقًا معقدًا باستخدام React، فمن المرجّح أنك تستخدم [Next](/sdk/using-or/next) أو [Remix](/sdk/using-or/remix) أو إطار عمل مشابه. تأكّد من الاطلاع على قسم [إعداد أداة التتبع](/sdk/using-or) للعثور على إطار العمل الذي تعمل به.
