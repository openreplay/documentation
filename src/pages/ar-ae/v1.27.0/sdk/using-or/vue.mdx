...
<Aside type="tip">
بينما يمكنك الحصول على [نسخة الـ snippet بلغة JS](/sdk/using-or/snippet#الحصول-على-المقتطف) من الـ tracker الخاص بنا مباشرةً من الـ CDN عند إنشاء مشروع جديد، فإن الكود بسيط للغاية وسيجعل من الصعب تخصيصه وإضافة إضافات (plugins) أخرى.
</Aside>
...
إذا كنت تبني تطبيقًا معقدًا باستخدام Vue، فمن المرجّح أنك تستخدم [Nuxt](/sdk/using-or/nuxt) أو شيئًا مشابهًا له. تأكّد من الاطلاع على قسم [Tracker Setup](/sdk/using-or) للعثور على إطار العمل (framework) الذي تعمل به.
