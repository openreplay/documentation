...
إذا واجهت أي مشكلة أثناء عملية الترقية، تواصل معنا على [Slack](https://slack.openreplay.com) أو اطّلع على [المنتدى](https://forum.openreplay.com) الخاص بنا واحصل على المساعدة من مجتمعنا.
