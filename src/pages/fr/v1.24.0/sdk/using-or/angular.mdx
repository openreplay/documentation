...
Vous pouvez [consulter ce dépôt](https://github.com/deleteman/openreplay-angular-example) pour le **code source complet** d'une application fonctionnelle basée sur Angular avec le Tracker.
