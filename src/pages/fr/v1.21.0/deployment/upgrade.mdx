---
title: "Mettre à niveau le déploiement"
metaTitle: "Mettre à niveau le déploiement"
metaDescription: "Comment mettre à niveau votre instance vers la dernière version d'OpenReplay."
---

Mettre à niveau votre déploiement OpenReplay vers la dernière version nécessite de mettre à jour à la fois votre backend (instance) et votre tracker.

## Mettre à niveau le backend (installation vanilla)
...
## Mettre à niveau le backend (Docker uniquement)
...
```
> Remarque : Votre fichier de configuration OpenReplay mis à jour sera stocké dans `common.env` avec le fichier docker-compose.
...
Si vous rencontrez un problème pendant le processus de mise à niveau, contactez-nous sur [Slack](https://slack.openreplay.com) ou consultez notre [Forum](https://forum.openreplay.com) et obtenez de l'aide de notre communauté.
