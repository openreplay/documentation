...
metaDescription: "Comment intégrer Elasticsearch à OpenReplay et voir les erreurs backend à côté des relectures de session."
---

Découvrez comment intégrer les journaux backend d'[Elastic](https://www.elastic.co/) aux relectures de session d'[OpenReplay](https://www.openreplay.com/) afin d'étendre vos capacités de surveillance et de débogage.
