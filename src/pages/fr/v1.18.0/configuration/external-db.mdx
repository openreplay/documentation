...
metaDescription: "Comment modifier la destination de base de données par défaut d'OpenReplay et en utiliser une externe."
---
...
5. Enregistrez et quittez avec `:wq` pour que les modifications prennent effet
