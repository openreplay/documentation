...
- `metadata: Record<string, string>` : définit manuellement des valeurs de métadonnées. Consultez la [section Métadonnées](/session-replay/metadata) pour en savoir plus sur cette fonctionnalité.
