---
title: "SDK Android - Initialisation du SDK"
metaTitle: "SDK Android - Initialisation du SDK"
...
Ajoutez la dépendance dans le fichier build.gradle de votre app :
```
dependencies {
...
Consultez [comment assainir les données dans les replays Android](/android-sdk/sanitization) pour plus de détails.
