...
metaDescription: "Apprenez à capturer les changements d'état à l'aide du plugin Redux et à les visualiser dans les rejeux de session"
---
...
Dans le cas de Redux, OpenReplay [fournit un plugin](https://docs.openreplay.com/plugins/redux) qui vous permet de vous intégrer au fonctionnement interne du store. Ce plugin vous laissera voir l'état (state) du store Redux ainsi que les actions dispatchées tout au long de la session enregistrée.
...
La logique de ceci sera ajoutée dans le fichier index.tsx, et vous pouvez consulter le code source complet de [ce fichier ici](https://github.com/deleteman/nextjs-commerce-example/blob/redux-store/site/pages/index.tsx).
...
Si vous rencontrez des problèmes pour configurer le plugin Redux, veuillez nous contacter sur notre [communauté Slack](https://slack.openreplay.com/) et poser directement vos questions à nos développeurs !
