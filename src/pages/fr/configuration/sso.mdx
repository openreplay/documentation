...
5. Si vous avez suivi les instructions du <a href="#certificat-openreplay">Certificat OpenReplay</a>, vous pouvez téléverser le fichier 'openreplay-sso.crt' généré en appuyant sur 'Upload SP Certificate' ; sinon, ignorez cette étape
