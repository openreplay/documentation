...
Si vous souhaitez nettoyer toutes les sessions, passez à [la partie suivante](#supprimer-toutes-les-sessions), car elle est plus rapide et libère instantanément de l'espace de stockage.
...
<Aside type="note">
	...
	De plus, cela nécessitera un peu de stockage libre pour fonctionner, c'est pourquoi nous recommandons vivement d'exécuter ces requêtes dans l'ordre croissant de [taille des tables](#vérifier-la-taille-des-tables)
</Aside>
