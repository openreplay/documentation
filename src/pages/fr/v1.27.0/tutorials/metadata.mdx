...
En d'autres termes, si l'utilisateur clique sur un lien spécifique ou effectue une action particulière, ce ne sont pas des métadonnées, c'est un événement personnalisé (consultez [la documentation sur les Événements Personnalisés](/product-analytics/custom-events) si vous souhaitez en savoir plus à leur sujet).
