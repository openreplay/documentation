...
Pour cet exemple, je vais utiliser la version NPM du paquet ; si vous ne savez pas comment faire, consultez [la documentation](https://docs.openreplay.com/deployment/setup-or) puis revenez ici.
