...
- (Recommandé) Ajoutez l'option `inlineCss: 3` au [constructeur du tracker](/sdk/constructor/#feuilles-de-style) afin que les feuilles de style soient capturées dans le cadre de chaque relecture (au lieu d'être mises en cache de manière centralisée par le serveur).
