...
3) La modification des options d'enregistrement des données a un impact sur l'extrait de code. Assurez-vous de copier/coller le script mis à jour dans votre application web.
...
Consultez également ce tutoriel étape par étape sur la façon de [capturer et assainir les requêtes réseau](/tutorials/capture-request).
