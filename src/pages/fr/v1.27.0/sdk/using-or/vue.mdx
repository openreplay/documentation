...
<Aside type="tip">
Bien que vous puissiez obtenir la [version snippet JS](/sdk/using-or/snippet#obtenir-le-snippet) de notre tracker directement depuis notre CDN lorsque vous créez un nouveau projet, le code est trop sommaire et rendra plus difficile sa personnalisation et l'ajout de plugins supplémentaires.
</Aside>
...
Si vous construisez une application complexe avec Vue, il y a de fortes chances que vous utilisiez [Nuxt](/sdk/using-or/nuxt) ou quelque chose de similaire. N'oubliez pas de consulter notre section [Tracker Setup](/sdk/using-or) pour trouver le framework avec lequel vous travaillez.
