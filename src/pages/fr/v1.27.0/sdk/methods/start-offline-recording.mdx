...
- `metadata: Record<string, string>` : définit manuellement les valeurs des métadonnées. Consultez la [section Métadonnées](/session-replay/metadata) pour en savoir plus sur cette fonctionnalité.
