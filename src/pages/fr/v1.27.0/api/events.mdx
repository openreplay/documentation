...
<p><span class="or-method ok">200</span> Réponse envoyée au format JSON dans le corps<br/>
<span class="or-method err">400</span> Corps non valide ou <code>sessionID</code> non valide (vide ou &gt; 256 caractères)</p>
