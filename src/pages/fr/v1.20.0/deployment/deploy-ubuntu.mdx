...
- Le système d'exploitation doit être *Ubuntu Server 22.04 Focal Fossa*.
...
1. Tout d'abord, rendez-vous chez votre fournisseur de services DNS, modifiez votre zone DNS et créez un `A Record`. Utilisez le domaine que vous avez fourni précédemment lors de l'étape d'installation et pointez-le vers la machine en utilisant son IP publique.
