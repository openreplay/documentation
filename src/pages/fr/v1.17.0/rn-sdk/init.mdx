...
<Aside type="caution">
	Le SDK React Native est en version Bêta et ne prend actuellement en charge que les applications iOS. N'hésitez pas à nous faire part de vos retours ou à signaler tout problème que vous pourriez rencontrer sur notre [Slack](https://slack.openreplay.com) ou consultez notre [Forum](https://forum.openreplay.com).
</Aside>
...
- `logs: Bool` Active l'écouteur de journaux.
