...
<Aside type="caution">
	Le iOS SDK est en Beta. N'hésitez pas à nous faire part de vos retours ou à signaler tout problème que vous pourriez rencontrer sur notre [Slack](https://slack.openreplay.com) ou consultez notre [Forum](https://forum.openreplay.com).
</Aside>
...
Consultez [comment assainir les données dans les relectures iOS](/ios-sdk/sanitization) pour plus de détails.
...
<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
	<ORCard title="Découvrez les méthodes et modules du iOS SDK" url="/ios-sdk/modules" hideIcon={true} width="100"/>
</div>
