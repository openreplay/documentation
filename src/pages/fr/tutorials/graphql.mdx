---
title: "Utiliser le plugin GraphQL"
metaTitle: "Utiliser le plugin GraphQL pour capturer et assainir les informations des opérations"
metaDescription: "Découvrez comment configurer le plugin GraphQL dans votre application React"
---
...
![L'interface GraphQL dans le Session Replay](/using-or/graphql-ui.png)
...
![Données assainies vs non assainies](/using-or/sanitized-vs-not-sanitized.png)
...
![Données assainies partout](/using-or/sanitized.png)
...
Si vous rencontrez des problèmes pour configurer le Tracker sur votre projet GraphQL, contactez-nous sur notre [communauté Slack](https://slack.openreplay.com/) et posez directement vos questions à nos développeurs !
