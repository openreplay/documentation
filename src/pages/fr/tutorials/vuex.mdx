...
![Suivre les changements d'état avec VueX](/using-or/vuex-ss.png)
...
Si vous rencontrez des problèmes pour configurer le Tracker ou le plugin VueX dans votre projet, contactez-nous sur notre [communauté Slack](https://slack.openreplay.com/) et posez directement vos questions à nos développeurs !
