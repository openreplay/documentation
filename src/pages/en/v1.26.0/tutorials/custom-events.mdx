...
![The product page](/tutorials/product-ui.png)
...
![Custom events panel](/tutorials/product-events-section.png)

And if we want the details, we can click on the “DETAILS” link that appears when you hover over one of the rows:

![Details of a custom event](/tutorials/event-details.png)
