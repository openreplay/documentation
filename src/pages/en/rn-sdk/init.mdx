...
```js
import Openreplay from '@openreplay/reactnative';
...
By default, all options are marked as `true`. Available options:
...
<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
	<ORCard title="Get to know the SDK" url="/rn-sdk/modules" hideIcon={true} width="100"/>
</div>
