...
http:
  ingress:
    annotations:
      ...
      # Specify the accepted origins for CORS
      nginx.ingress.kubernetes.io/cors-allow-origin: "https://origin-site1.com:443,http://origin-site2.com"
      # Keep the below lines
      nginx.ingress.kubernetes.io/cors-allow-headers: "DNT,Keep-Alive,User-Agent,X-Requested-With,If-Modified-Since,Cache-Control,Content-Type,Range,Authorization,Content-Encoding,Content-Length"
