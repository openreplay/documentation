...
| Field | Value |
|----------|-------------|
| tenantKey | <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/></code> its value can be found in the Dashboard, under 'Preferences' > 'Account' (this attribute must be ignored/skipped if you're using our Cloud Dedicated plan) |
...
3. Save and quit using `:wq` for the changes to take effect
4. Add the generated 'openreplay-sso.crt' file to your Identity Provider's application configuration
...
5. Define the below fields in 'Attribute Statements':
 - **tenantKey**: format `Basic` and set the value to <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/></code>, found in OpenReplay dashboard under 'Preferences' > 'Account' (this attribute must be ignored/skipped if you're using our Cloud Dedicated plan)
...
5. Add the below claims in 'Attribute & Claims' block and ensure the 'Namespace' field is left empty for each of them:
 - **tenantKey**: set the value to <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/></code>, found in OpenReplay dashboard under 'Preferences' > 'Account' (this attribute/claim must be ignored/skipped if you're using our Cloud Dedicated plan)
...
- **tenantKey**: set the value to <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/></code>, found in OpenReplay dashboard under 'Preferences' > 'Account' (this attribute must be ignored/skipped if you're using our Cloud Dedicated plan)
