...
4. Navigate to 'Single sign-on' in the left-side menu and set the below values in the 'Basic SAML Configuration' block:
 - **Identifier (Entity ID)** to <code><ORDynamicCode id="domain" initialValue={initialValues.domain} client:idle/>:<ORDynamicCode id="port" initialValue={initialValues.port} client:idle/>/api/sso/saml2/metadata/</code>
 - **Reply URL (Assertion Consumer Service URL)** to <code><ORDynamicCode id="domain" initialValue={initialValues.domain} client:idle/>:<ORDynamicCode id="port" initialValue={initialValues.port} client:idle/>/api/sso/saml2/acs/</code>
 - **Logout URL** to <code><ORDynamicCode id="domain" initialValue={initialValues.domain} client:idle/>:<ORDynamicCode id="port" initialValue={initialValues.port} client:idle/>/api/sso/saml2/sls/</code>
5. Add the below claims in 'Attribute & Claims' block:
 - **tenantKey**: set the value to <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/>:<ORDynamicCode id="port" initialValue={initialValues.port} client:idle/></code>, found in OpenReplay dashboard under 'Preferences' > 'Account'
...
7. Now SSH into your OpenReplay installation and run `openrepaly -e`
