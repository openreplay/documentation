...
| Client id | <code><ORDynamicCode id="tenantId" initialValue={initialValues.tenantId} client:idle/></code> it's value can be found in the Dashboard, under 'Preferences' > 'Account' |
| Client secret | <code><ORDynamicCode id="tenantKey" initialValue={initialValues.tenantKey} client:idle/></code> it's value can be found in the Dashboard, under 'Preferences' > 'Account' |
