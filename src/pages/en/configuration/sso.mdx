...
4. Save your changes using `:wq` to apply the changes.
...
10. Under the `chalice` section, uncomment then set the following env variables:
   ...
   - **idp_name**: Okta
12. Finally, save your changes using `:wq` to apply the changes.
...
15. Finally, save your changes using `:wq` to apply the changes.
