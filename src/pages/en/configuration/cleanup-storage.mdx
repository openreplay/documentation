...
OpenReplay stores temporary data in filesystem prior to processing and uploading to s3. After the processing, these data are deprecated, and a cronjob will delete this data every 2nd day of week at night 3:05. If you want to cleanup daily or faster, you can change the configuration. Eg:

Edit OpenReplay configuration

```bash
openreplay -e
```

To change the cronjob timing, append the following
