...
```
Save and quit using `:wq` for the changes to take effect.

7. You can test the setup by inviting yourself (using another email) as a new team member (in 'Preferences' > 'Users').
