...
Integrate Teams with OpenReplay and share insights with the rest of the team, directly from the recording page.

### 1. Create a personal access token

1. Login to your Teams workspace then go to Teams tab > your specific channel
...
2. Select Microsoft Teams and paste the previously copied Webhook URL before clicking 'Add'
