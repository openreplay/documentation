...
<div class="grid grid-cols-4 grid-flow-col gap-4">
  <a href="/getting-started/" class="card justify-center p-2 flex gap-2 no-decoration">
  ...
  <a href="/deployment/upgrade/" class="card p-2 flex gap-2 justify-center">
  ...
  <a href="/troubleshooting" class="card p-2 flex gap-2 justify-center">
  ...
  <a href="/installation/sanitize-data/"class="card p-2 flex gap-2 justify-center">
