---
title: "React Native SDK - event method"
metaTitle: "React Native SDK - event method"
metaDescription: "Details about the event method from OpenReplay's React Native SDK"
---
...
- `payload: string`: The content of the event. This can be any string encoded (JSON) data.
