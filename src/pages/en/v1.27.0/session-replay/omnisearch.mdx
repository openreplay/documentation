...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/events.png" alt="Events dropdown" style={{ width: '600px', height: 'auto' }} />
</div>   
2. **Filters dropdown:** Apply filters to narrow down results by user data, session properties, issues, and metadata
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/filters.png" alt="Filters dropdown" style={{ width: '600px', height: 'auto' }} />
</div>   
3. **Logic controls:** Switch between sequential ("Then") and parallel ("And"/"OR") events occurrence.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/logic_control.png" alt="Logic control options" style={{ width: '600px', height: 'auto' }} />
</div>
4. **Search operators:** Refine searches with "is," "contains," "starts with," and more
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/operators.png" alt="operators" style={{ width: '600px', height: 'auto' }} />
</div>
5. **Drag-and-drop events**: Rearrange events order to refine your search.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/drag_drop.png" alt="drag and drop events" style={{ width: '600px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/saved_search.png" alt="saved search" style={{ width: '600px', height: 'auto' }} />
</div>
...
| Custom Events | User defined events, sent using the SDK. |
