...
Use the `sanitizer` option to redact sensitive data from Fetch/XHR request/response. See the [network options](/sdk/network-options#options) for more details.
