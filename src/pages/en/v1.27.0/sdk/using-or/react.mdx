...
<Aside type="tip">
While you can get the [JS snippet version](/sdk/using-or/snippet#getting-the-snippet) of our tracker directly from our CDN when you create a new project, the code is too barebone and will make it harder to customize and add extra plugins.
</Aside>
...
If you're building a complex application with React, chances are you're using [Next](/sdk/using-or/next), [Remix](/sdk/using-or/remix) or a similar framework. Make sure to check out our [Tracker Setup](/sdk/using-or) section to find the framework you're working with.
