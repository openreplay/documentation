...
If you're building a complext applicaton with Vue, chances are you're using [Nuxt](/sdk/using-or/nuxt) or something like it. Make sure to check out our [Tracker Setup](/sdk/using-or) section to find the framework you're working with.
