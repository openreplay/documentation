...
The sessions deletion will be done on 2 parts, removing the sessions from the database when the delete-job is executed at midnight of the next day, and removing the replay file from storage after 30 days.
In case you want to delete the replay files in a different date, you can follow these instructions:
...
7. To delete replay files 14 days after the delete-job execution
