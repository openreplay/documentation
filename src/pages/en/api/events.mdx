...
<p><span class="or-method ok">200</span> Response sent as JSON in body<br/>
<span class="or-method err">400</span> Invalid body or invalid <code>sessionID</code> (empty or &gt; 256 chars)</p>
