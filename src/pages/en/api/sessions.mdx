...
Returns the list of sessions for a particular user, who has been identified via the `tracker.setUserID` JavaScript function. Results are limited to 50 sessions per request.
