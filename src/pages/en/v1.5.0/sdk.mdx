...
<div class="grid grid-cols-1 md:grid-cols-12 gap-6 ">
  <ORCard title="1. Initialize it" url="/sdk/constructor" description="Learn how to install and initialize the tracker" width="50"/>
  <ORCard title="2. Know the methods" url="/sdk/methods" description="The list of all public methods you can use to change the way you track your sessions" width="50"/>
</div>
