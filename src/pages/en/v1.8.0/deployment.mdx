...
<ORCard url="/deployment/openreplay-admin" title="Administer OpenReplay"   description="For easy management of your instance by directly accessing logs, reinstalling services, increasing capacity and more." icon="administer" />
<ORCard url="/deployment/upgrade" title="Upgrade Deployment"   description="Ensure that your OpenReplay instance stays current by upgrading it to the newest version." icon="upgrade" />
</div>