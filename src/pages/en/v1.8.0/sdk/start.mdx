...
This method is used to start the tracker. 
By starting the tracker, the recording of the session starts.
...
Starts the tracker (and the recording process) then returns a promise with session info (sessionID, sessionHash, userUUID).
