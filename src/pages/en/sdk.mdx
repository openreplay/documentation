...
<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
  <ORCard title="1. Install the SDK" url="/sdk/installation" hideIcon={true} width="30"/>
  <ORCard title="2. Initialize it" url="/sdk/constructor" hideIcon={true} width="30"/>
  <ORCard title="3. Get to know the methods" url="/sdk/methods" hideIcon={true} width="30"/>
</div>
