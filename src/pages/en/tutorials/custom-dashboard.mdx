...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/dashboard_overview.gif" alt="Dashboard Overview" style={{ width: '600px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/rename_delete.png" alt="Rename or delete Dashboard" style={{ width: '600px', height: 'auto' }} />
</div>  
- **Change Visibility:** Set the dashboard to **Team** or **Private** based on who should access it.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/dashboard_visibility.png" alt="Rename or delete Dashboard" style={{ width: '600px', height: 'auto' }} />
</div>    
- **Reorganize cards:** Drag and drop cards to rearrange them.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/organize_cards.gif" alt="Rename or delete Dashboard" style={{ width: '600px', height: 'auto' }} />
</div>    
- **Remove cards:** Use the "Remove from Dashboard" button to delete a card.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/remove_card.png" alt="Rename or delete Dashboard" style={{ width: '600px', height: 'auto' }} />
</div>    
- **Filtering:** Apply time-based filters (24 hours, 7 days, etc.)
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="./images/custom-dashboard/time_filter.png" alt="Rename or delete Dashboard" style={{ width: '600px', height: 'auto' }} />
</div>
