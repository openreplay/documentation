...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/events.png" alt="Events dropdown" style={{ width: '500px', height: 'auto' }} />
</div>   
2. **Filters dropdown:** Apply filters to narrow down results by user data, session properties, issues, and metadata
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/filters.png" alt="Filters dropdown" style={{ width: '500px', height: 'auto' }} />
</div>   
3. **Logic controls:** Switch between sequential ("Then") and parallel ("And"/"OR") events occurrence.
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/logic_control.png" alt="Logic control options" style={{ width: '500px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/drag_drop.png" alt="drag and drop events" style={{ width: '500px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/omnisearch/saved_search.png" alt="saved search" style={{ width: '500px', height: 'auto' }} />
</div>
