...
- `defaultInputMode?: 0 | 1 | 2` Default capture mode for input values. Respectively: plain, obscured or ignored. Default: `1` (plain).
...
- `nthThreshold?: number` Number of selector tries before falling back to nth-child selectors. Default: `1000`. **This is an expensive operation and may incur a significant overhead, do not set higher than 2000**.
