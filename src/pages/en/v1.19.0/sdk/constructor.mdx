...
- `obscureInputDates?: boolean` Obscures dates in input fields. Date values will be converted to a random chain of asterisks. Default: `false`.
...
See [Canvas and WebGL](/installation/canvas) for how to enable this capability and more details on the available options.
...
See [Cross-domain iFrame Tracking](/tutorials/crossdomain-iframe) for more details on how to capture an iFrame from a different domain. 
