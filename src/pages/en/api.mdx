...
- Cloud Dedicated / self-hosted: `https://YOUR_INSTANCE_DOMAIN/v2/api`
...
<div class="or-rowlist">
  <LinkRow href="/api/projects" title="Projects" icon="settings" desc="For creating and retrieving projects." />
  ...
  <LinkRow href="/api/users" title="Users" icon="user" desc="For searching, retrieving and deleting user data." />
  <LinkRow href="/api/jobs" title="Jobs" icon="data" desc="For managing user data deletion jobs." />
  <LinkRow href="/api/assist" title="Assist" icon="session" desc="For retrieving live sessions (EE)." />
</div>
