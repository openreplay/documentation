...
To enable SSO, edit `/var/lib/openreplay/vars.yaml` and uncomment then update the below env variables in `chalice` section:
...
```
2. In your server, edit your `/var/lib/openreplay/vars.yaml`
...
9. In your server, edit your `/var/lib/openreplay/vars.yaml`
...
9. Finally, save your changes and reinstall the web server:
