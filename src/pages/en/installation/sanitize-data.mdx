---
title: "Sanitize Data (JS)"
metaTitle: "Sanitize Data (JS)"
...
<Aside type="tip">
If you'd like to watch a quick tutorial on how to sanitize data in your replays, use [this YouTube video](https://youtu.be/22-UCoocy6s), otherwise keep reading for more details.
</Aside>
...
We are constantly improving our privacy related features, so let us know if you need something that we don't support yet. If you're having trouble sanitizing your data, please reach out to our [Slack](https://slack.openreplay.com) and get help from our community.