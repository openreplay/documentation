...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials//roles-and-access/add_role.gif" alt="Add Role" style={{ width: '600px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials//roles-and-access/delete_role.gif" alt="Delete Role" style={{ width: '600px', height: 'auto' }} />
</div>
