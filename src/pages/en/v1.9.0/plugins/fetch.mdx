...
<YoutubeVideo title="Watch how to use the Fetch plugin"
  description="If you don't like reading, you can follow this video tutorial showing you how to track network request and sanitize the data inside them using the Fetch pluing."
  videoURL="https://www.youtube.com/watch?v=YFCKstPZzZg"
  />


<Aside type="tip">
  We also have a detailed tutorial on how to use the Fetch plugin to capture all HTTP requests, you can check it out [here](/tutorials/fetch).
</Aside>
