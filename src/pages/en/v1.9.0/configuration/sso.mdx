...
10. Under the `chalice` section, uncomment then set the following env variables:
		...
		- **idp_x509cert**: the downloaded certificate, must be a one-line string, without line breaks (ou can use the [FORMAT A X509 CERTIFICATE tool](https://www.samltool.com/format_x509cert.php) to format your value)
		- **idp_name**: JumpCloud
12. Finally, save your changes and reinstall the web server:
```bash
cd openreplay/scripts/helmcharts && ./openreplay-cli -I
