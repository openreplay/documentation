...
<Aside type="tip">
  We also have a detailed tutorial on how to use the Redux plugin to capture the state of your application when using this library, you can check it out [here](/tutorials/vuex)
</Aside>
