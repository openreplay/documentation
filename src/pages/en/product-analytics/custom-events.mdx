...
Use the `event` method to signal functional events such as *order completed* or *product added*. It takes 2 parameters: *name* (string) and *payload* (any non-recursive JS object).
...
Our SDK supports more in-depth events management, to read more check out [Data and Event Management Section](product-analytics/data-management).
