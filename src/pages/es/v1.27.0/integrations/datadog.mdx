...
Aprende cómo integrar los errores de backend de [Datadog](https://www.datadoghq.com/) con las repeticiones de sesión de [OpenReplay](https://www.openreplay.com/) para ampliar tus capacidades de monitoreo y depuración.

## 1. Genera la API Key y la Application Key de Datadog

1. Ve a **[Datadog > Integrations > APIs](https://app.datadoghq.com/account/settings#api)** y genera la API Key, o usa la existente.
