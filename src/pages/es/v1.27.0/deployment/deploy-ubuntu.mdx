...
La pila de OpenReplay se puede instalar en una sola máquina que ejecute Ubuntu. Aquí te explicamos cómo hacerlo.

## Pre-requisitos

- El sistema operativo debe ser *Ubuntu Server 24.04 LTS*.
