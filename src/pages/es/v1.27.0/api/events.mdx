...
<p><span class="or-method ok">200</span> Respuesta enviada como JSON en el cuerpo<br/>
<span class="or-method err">400</span> Cuerpo no válido o <code>sessionID</code> no válido (vacío o &gt; 256 caracteres)</p>
