...
- `metadata: Record<string, string>`: Establece manualmente los valores de los metadatos. Consulta la [sección de metadatos](/session-replay/metadata) para obtener más información al respecto.
