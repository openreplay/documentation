...
- `metadata: Record<string, string>`: establece manualmente los valores de los metadatos. Consulta la [sección de Metadatos](/session-replay/metadata) para obtener más información sobre esta función.
