...
- `metadata: Record<string, string>`: establece manualmente valores de metadatos. Consulta la [sección de Metadatos](/session-replay/metadata) para obtener más información sobre esta función.
