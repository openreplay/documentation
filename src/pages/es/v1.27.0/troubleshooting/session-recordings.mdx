...
- (Recomendado) Añade la opción `inlineCss: 3` al [constructor del tracker](/sdk/constructor/#stylesheets) para que las hojas de estilo se capturen como parte de cada reproducción (en lugar de almacenarse de forma centralizada en la caché del servidor).
