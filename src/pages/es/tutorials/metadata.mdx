...
metaTitle: "Añadir metadatos a tus repeticiones de sesión para potenciar tus insights"
...
<YoutubeVideo title="Mira cómo enviar metadatos desde tu aplicación Next.js"
  description="Si no te gusta leer, puedes seguir este video tutorial que te muestra cómo enviar metadatos desde tu aplicación hacia la plataforma OpenReplay"
...
**Ten en cuenta** que existe una [versión en video de este tutorial](https://www.youtube.com/watch?v=ITcJCeKWQGU) en nuestro canal de YouTube. Así que no dudes en verla si aprendes mejor de forma visual.
...
En otras palabras, si el usuario hace clic en un enlace específico o realiza una acción en particular, eso no son metadatos, eso es un evento personalizado (consulta [la documentación sobre Eventos Personalizados](/product-analytics/custom-events) si quieres saber más sobre ellos).
