...
<Aside type="caution">
	El SDK de React Native está en fase Beta y actualmente solo es compatible con aplicaciones de iOS. No dudes en enviarnos tus comentarios o informar de cualquier problema que encuentres en nuestro [Slack](https://slack.openreplay.com) o consultar nuestro [Foro](https://forum.openreplay.com).
</Aside>
