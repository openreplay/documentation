...
- `assistSocketHost?: string` Se puede utilizar para establecer un host específico para la conexión del plugin Assist. Por defecto es el valor de `ingestPoint`.
