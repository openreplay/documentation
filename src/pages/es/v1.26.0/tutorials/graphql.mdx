...
---
Si usas GraphQL como lenguaje de consulta para tus APIs desde dentro de tu aplicación, entonces el [plugin de GraphQL](https://docs.openreplay.com/plugins/graphql) puede ayudarte a rastrear tanto las mutaciones como las consultas que se ejecutan contra tu servidor de GraphQL.
...
![La interfaz de GraphQL dentro del Session Replay](/using-or/graphql-ui.png)
...
![Datos saneados vs. no saneados](/using-or/sanitized-vs-not-sanitized.png)
...
![Datos saneados en todas partes](/using-or/sanitized.png)

## ¿Tienes preguntas?

Puedes [echar un vistazo a este repositorio](https://github.com/deleteman/openreplay-graphql-example) para ver el **código fuente completo** de una aplicación basada en GraphQL que funciona con el Tracker.
