...
metaTitle: "Problemas con las grabaciones de sesiones"
...
Si ves un error similar al siguiente, significa que OpenReplay no pudo iniciarse debido a la falta de una política de seguridad de contenido. Consulta [aquí](/troubleshooting/csp) la política que debes añadir.
...
- (Recomendado) Añade la opción `inlineCss: 3` al [constructor del tracker](/sdk/constructor/#hojas-de-estilo) para que las hojas de estilo se capturen como parte de cada reproducción (en lugar de almacenarse de forma centralizada en la caché del servidor).
- O puedes copiar tus recursos a un dominio de acceso público y luego usar la opción `resourceBaseHref` para especificar el dominio en el [constructor del tracker](/sdk/constructor).
