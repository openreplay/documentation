...
Si quieres limpiar todas las sesiones, pasa a [la siguiente parte](#eliminar-todas-las-sesiones), ya que es más rápida y libera espacio de almacenamiento al instante.
...
<Aside type="note">
	...
	Además, requerirá algo de almacenamiento libre para poder funcionar, por eso recomendamos encarecidamente ejecutar estas consultas en orden ascendente de [tamaño de las tablas](#comprobar-el-tamaño-de-las-tablas)
</Aside>
