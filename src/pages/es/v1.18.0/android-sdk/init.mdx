---
title: "Android SDK - Inicialización del SDK"
metaTitle: "Android SDK - Inicialización del SDK"
...
<Aside type="caution">
	El SDK de Android está en fase Beta. No dudes en darnos tu opinión o reportar cualquier problema que encuentres en nuestro [Slack](https://slack.openreplay.com) o consulta nuestro [Foro](https://forum.openreplay.com).
</Aside>
...
Consulta [cómo sanear datos en las grabaciones de Android](/android-sdk/sanitization) para más detalles.
...
<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
	<ORCard title="Conoce los métodos y módulos del SDK de Android" url="/ios-sdk/modules" hideIcon={true} width="100"/>
</div>
