...
<Aside type="tip">
Aunque puedes obtener la [versión del snippet JS](/sdk/using-or/snippet#obtener-el-snippet) de nuestro tracker directamente desde nuestra CDN al crear un nuevo proyecto, el código es demasiado básico y dificultará su personalización y la incorporación de plugins adicionales.
</Aside>
...
Si estás construyendo una aplicación compleja con Vue, es probable que estés usando [Nuxt](/sdk/using-or/nuxt) o algo similar. Asegúrate de consultar nuestra sección [Tracker Setup](/sdk/using-or) para encontrar el framework con el que estás trabajando.
