...
<Aside type="tip">
Aunque puedes obtener la [versión en snippet de JS](/sdk/using-or/snippet#obtener-el-snippet) de nuestro tracker directamente desde nuestra CDN al crear un nuevo proyecto, el código es demasiado básico y dificultará personalizarlo y añadir plugins adicionales.
</Aside>
...
Si estás creando una aplicación compleja con React, lo más probable es que estés usando [Next](/sdk/using-or/next), [Remix](/sdk/using-or/remix) o un framework similar. Asegúrate de consultar nuestra sección [Configuración del Tracker](/sdk/using-or) para encontrar el framework con el que estás trabajando.
