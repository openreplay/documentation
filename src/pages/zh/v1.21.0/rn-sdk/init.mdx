...
<Aside type="caution">
	React Native SDK 目前处于 Beta 阶段。欢迎在我们的 [Slack](https://slack.openreplay.com) 上向我们提供反馈或报告您遇到的任何问题，或访问我们的[论坛](https://forum.openreplay.com)。
</Aside>

## 安装

下面这行命令将安装跟踪器及其 SDK，让您能够使用跟踪器的所有功能。
...
- `ORTrackedInput` - 对 React-Native Input 的封装，在用户完成输入时发送信号
- `ORSanitizedView` - 对其中的内容进行模糊处理
...
有关更多详细信息，请参阅[如何在 React Native 回放中进行数据脱敏](/rn-sdk/sanitization)。
