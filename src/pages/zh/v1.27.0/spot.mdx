...
metaDescription: "录制并报告错误，提供开发人员修复所需的全部上下文。"
---
...
- Spot 包含在每个 [OpenReplay 套餐](https://www.openreplay.com/pricing.html)中，从我们的开源版本到企业版产品均涵盖在内。
- Spot 是一款 *Chrome 扩展程序*，它也可以在任何基于 Chromium 的浏览器上运行，包括 [Microsoft Edge](https://www.microsoft.com/en-us/edge)、[Brave](https://brave.com/) 和 [Arc](https://arc.net/)。
...
1. 前往 [**Chrome 应用商店中的 Spot 扩展程序页面**](https://chromewebstore.google.com/detail/openreplay-spot-record-re/ckigbicapkkgfomcfmcbaaplllopgbid) 并点击“添加至 Chrome”。
2. 将 Spot 固定到你的 Chrome 工具栏，以便日后轻松访问。

<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/tutorials/spot/add_to_chrome.gif" alt="将 Spot 添加至 Chrome" style={{ width: '600px', height: 'auto' }} />
</div>
