...
metaDescription: "在使用 Pinia 时，借助 Pinia 插件跟踪你的状态变化"
minVersion: "1.6.0"
---
...
Pinia 是用于 Vue 项目的状态管理库，它取代了 VueX。以前你使用 VueX 的地方，现在将改用 Pinia。借助我们的 [Pinia 插件](/plugins/pinia)，你可以在应用的整个生命周期中跟踪状态变化。
...
**注意**：本示例的完整源代码位于这个 [GitHub 仓库](https://github.com/deleteman/openreplay-vue-pinia-example)，如果你需要更多细节，可以查看它。
...
**注意**解构属性的名称与 `name` 属性的值相同。只要保持这两者一致，就没有问题。
...
你可以[查看这个仓库](https://github.com/deleteman/openreplay-vue-pinia-example)，获取一个使用 Pinia 插件的可运行 Pinia/Vue 应用的**完整源代码**。如果你在项目中设置 Pinia 插件时遇到任何问题，请在我们的 [Slack 社区](https://slack.openreplay.com/)联系我们，直接向我们的开发者提问！
