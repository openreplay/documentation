...
<div class="col-span-12 card mt-0">
   <div class="relative border text-left">
      <div class="relative flex flex-col gap-3">
         ...
         <span class="flex-grow">OpenReplay可以在任何地方部署。按照我们的分步指南在主要的公共云和平台上部署它。</span>
      </div>
      <div class="mt-6">
         <div class="hidden">
            ...
            <ul class="ml-4 pl-0">
               <li>
                  <a href="/using-or/">使用您喜欢的框架设置跟踪器</a>
 							...
 							<li>
 								<a href="/ios-sdk/init">为您的iOS应用程序设置跟踪器（测试版）</a>
 							</li>
               <li>
               ...
               <li>
                  <a href="/plugins/assist/">启用Assist进行实时会话回放</a>
               </li>
            </ul>
      </div>
...
<div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    <ORCard 
        url="/plugins/" 
        title="Plugins" 
        description="与其他库集成，并使用Redux和Pinia等插件跟踪您的应用程序状态。"
        width="50"
				btnText="了解更多"
    />
   <ORCard 
        url="/integrations/" 
        title="Integrations" 
        description="将OpenReplay集成到您的工作流程中，以简化数据管理并改进协作。"
        width="50"
				btnText="了解更多"
    />
    <ORCard 
        ...
        description="通过设置外部存储、从数据库中删除录音并保护您的安装来扩展您的OpenReplay实例。"
        width="50"
				btnText="了解更多"
    />
    <ORCard 
        url="/installation/" 
        title="How-Tos"
        description=" 使用OpenReplay执行高级操作。上传源代码映射，发送自定义事件并报告应用程序错误。"
        width="50"
				btnText="了解更多"
    />
