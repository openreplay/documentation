...
<div class="col-span-12 card mt-0">
   <div class="relative border text-left">
      <div class="relative flex flex-col gap-3">
         ...
         <span class="flex-grow">OpenReplay 可以在任何地方部署。按照我们的分步指南在主要的公共云和平台上部署它。</span>
      </div>
      <div class="mt-6">
         <div class="hidden">
...
<div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    <ORCard 
        url="/configuration/" 
        title="配置"
        description="通过设置外部存储、从数据库中删除录制内容并保护您的安装来扩展您的 OpenReplay 实例。"
        width="50"
    />
    <ORCard 
        url="/plugins/" 
        title="Plugins" 
        description="与其他库集成，并使用 Redux 和 Pinia 等插件跟踪您的应用程序状态。"
        width="50"
    />
   <ORCard 
        url="/integrations/" 
        title="集成" 
        description="将 OpenReplay 与其他工具集成，以将您的后端日志与会话回放同步、向您的工单系统报告问题等等。"
        width="50"
    />
    <ORCard 
        url="/api/" 
        title="API" 
        description="管理用户数据并导出捕获的事件以进行外部分析。"
        width="50"
    />
</div>
...
<div class="gradient-bg grid">
    <ORCard 
        url="/spot/" 
        title="Chrome 扩展程序：OpenReplay Spot"
        description="记录并报告错误，提供工程师修复它们所需的所有详细信息。"
        width="50"
 ...
 <div class="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4">
    <a class="card hover-bg" href="https://github.com/openreplay/documentation">
            <div class="relative flex flex-col gap-3 p-4">
                ...
                <span class="flex-grow text-sm">让更多人能够访问 OpenReplay！将我们的文档翻译成您的语言。 </span>
        </div>
    </a>
   <a class="card bg-slack hover-bg" href="https://openreplay.slack.com/">
            <div class="relative flex flex-col gap-3 p-4">
                ...
                <span class="flex-grow text-sm">与社区分享您的专业知识，提问，并从同行中找到您需要的答案。</span>
            </div>
    </a>
    <a class="card bg-youtube hover-bg" href="https://www.youtube.com/@openreplay">
            <div class="relative flex flex-col gap-3 p-4">
                ...
                <span class="flex-grow text-sm">探索功能演练和逐步教程，以获得清晰的操作指南。</span>
            </div>
    </a>
</div>
</div>
