...
metaDescription: "iOS 追踪器构造方法的配置选项"
---
import Aside from '~/components/Aside.astro'
import ORCard from '~/components/Card/ORCard.astro'

<Aside type="caution">
	iOS SDK 目前处于 Beta 阶段。欢迎在我们的 [Slack](https://slack.openreplay.com) 上向我们提供反馈或报告您遇到的任何问题，也可以查看我们的[论坛](https://forum.openreplay.com)。
</Aside>
...
<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
	<ORCard title="了解 iOS SDK 的模块" url="/ios-sdk/modules" hideIcon={true} width="100"/>
</div>

## 方法

<div class="grid grid-cols-12 md:grid-cols-12 gap-3 md:gap-4">
	<ORCard title="了解 iOS SDK 的方法" url="/ios-sdk/methods" hideIcon={true} width="100"/>
</div>

## 有疑问？
如果您对此过程有任何疑问，欢迎在我们的 [Slack](https://slack.openreplay.com) 上联系我们，也可以查看我们的[论坛](https://forum.openreplay.com)。
