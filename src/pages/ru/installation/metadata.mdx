...
Ниже приведен пример того, как внедрить метаданные (в этом примере «план») с помощью сниппета. Обратите внимание на переменную/строку «startOpts», а также на изменения параметров во второй строке.
