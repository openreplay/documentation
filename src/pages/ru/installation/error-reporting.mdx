...
* Перехваченные исключения - [Ошибка](https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Error)
* Отклоненные обещания - [Событие отклонения обещания](https://developer.mozilla.org/ru/docs/Web/API/PromiseRejectionEvent)
* События ошибок (onError) - [Событие ошибки](https://developer.mozilla.org/ru/docs/Web/API/ErrorEvent)
...
По умолчанию перехваченные исключения не записываются во вкладку «Консоль». Чтобы отчитать ошибку, мы можем сделать следующее:
