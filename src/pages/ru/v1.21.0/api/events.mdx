...
Возвращает список событий, таких как клики, посещения страниц или ввод данных, содержащихся в конкретной записи сессии. Это высокоуровневые (индексированные) события, которые можно искать в приложении OpenReplay.
