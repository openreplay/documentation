...
Затем откройте файл `vars.yaml` командой `vim /var/lib/openreplay/vars.yaml` и замените:
...
OpenReplay имеет дело с чувствительными данными пользователей и поэт
```yaml
