...
<Aside type="tip">
Хотя вы можете получить [версию трекера в виде JS-сниппета](/sdk/using-or/snippet#получение-сниппета) напрямую из нашей CDN при создании нового проекта, этот код слишком минималистичен и усложнит его настройку, а также добавление дополнительных плагинов.
</Aside>
...
Если вы создаёте сложное приложение на React, скорее всего, вы используете [Next](/sdk/using-or/next), [Remix](/sdk/using-or/remix) или похожий фреймворк. Обязательно загляните в наш раздел [Настройка трекера](/sdk/using-or), чтобы найти фреймворк, с которым вы работаете.
