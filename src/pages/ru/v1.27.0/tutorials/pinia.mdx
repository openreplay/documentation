...
<YoutubeVideo title="Посмотрите, как отслеживать состояние с помощью Pinia"
  description="Если вы не любите читать, вы можете посмотреть этот видеоурок, в котором показано, как отслеживать состояние ваших Vue-приложений при использовании Pinia"
  videoURL="https://youtu.be/0TE5dfzz4-c"
/>

Pinia — это библиотека управления состоянием, пришедшая на смену VueX в проектах на Vue. Там, где раньше вы использовали VueX, теперь вы будете использовать Pinia. С нашим [плагином Pinia](/plugins/pinia) вы можете отслеживать изменения состояния на протяжении всего жизненного цикла вашего приложения.
...
**Примечание**: полный исходный код этого примера находится в этом [репозитории GitHub](https://github.com/deleteman/openreplay-vue-pinia-example); загляните туда, если вам нужны дополнительные подробности.
