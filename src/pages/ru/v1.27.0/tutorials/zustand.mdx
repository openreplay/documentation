...
Вы можете [ознакомиться с этим репозиторием](https://github.com/deleteman/nextjs-commerce-example/tree/zustand-store), чтобы увидеть **полный исходный код** рабочего приложения Next.js с плагином Zustand.
