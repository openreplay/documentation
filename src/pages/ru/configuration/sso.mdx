...
5. Если вы следовали инструкциям из раздела <a href="#сертификат-openreplay">Сертификат OpenReplay</a>, вы можете загрузить сгенерированный файл 'openreplay-sso.crt', нажав 'Upload SP Certificate'; в противном случае пропустите этот шаг
