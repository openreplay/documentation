...
---
Если вы используете GraphQL как язык запросов для ваших API внутри приложения, то [GraphQL plugin](https://docs.openreplay.com/plugins/graphql) поможет вам отслеживать как мутации, так и запросы, выполняемые к вашему серверу GraphQL.
...
Если вы хотите повторять действия по ходу, вы можете [посмотреть этот репозиторий](https://github.com/deleteman/openreplay-graphql-example), который содержит как сервер GraphQL, так и клиентское приложение.
...
Вы можете [посмотреть этот репозиторий](https://github.com/deleteman/openreplay-graphql-example), чтобы увидеть **полный исходный код** рабочего приложения на основе GraphQL с Tracker.

Если у вас возникнут какие-либо проблемы с настройкой Tracker в вашем проекте GraphQL, свяжитесь с нами в нашем [сообществе в Slack](https://slack.openreplay.com/) и задайте вопрос напрямую нашим разработчикам!
