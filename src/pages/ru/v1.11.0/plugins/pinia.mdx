...
<Aside type="tip">
  У нас также есть подробное руководство по использованию плагина Pinia для захвата состояния вашего приложения при использовании этой библиотеки, вы можете посмотреть его [здесь](/tutorials/pinia).
</Aside>
