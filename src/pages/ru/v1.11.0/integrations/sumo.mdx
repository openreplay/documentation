...
Для получения дополнительной информации о создании Access ID и Access Key, пожалуйста, обратитесь к этой документации [documentation](https://help.sumologic.com/Manage/Security/Access-Keys).
...
Для того, чтобы OpenReplay связал сообщение SumoLogic с записанной пользовательской сессией, должен быть распространен уникальный токен при каждой ошибке бэкенда, которую вы хотите отслеживать.
