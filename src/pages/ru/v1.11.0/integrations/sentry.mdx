...
Если вы используете Sentry на фронтенде, вы можете воспользоваться следующим примером.
