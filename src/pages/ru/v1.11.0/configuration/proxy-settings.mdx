...
Убедитесь, что модули `proxy`, `proxy_http` и `proxy_html` включены. Для работы OpenReplay также должен быть настроен SSL. Остальные настройки должны быть похожи на следующие:
