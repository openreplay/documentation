...
1. В консоли GCP перейдите на страницу [Создание ключа службы учетной записи](https://console.cloud.google.com/apis/credentials/serviceaccountkey?_ga=2.65088365.-270704106.1563504222).
2. В списке служб учетной записи выберите *Новая служба учетной записи*.
3. В поле имени службы учетной записи введите «openreplay-stackdriver».
4. В списке ролей добавьте *Logging > Logs Viewer* и *Stackdriver > Stackdriver Accounts Viewer*.
5. Нажмите *Создать*, чтобы загрузить файл JSON, содержащий ваш ключ.
