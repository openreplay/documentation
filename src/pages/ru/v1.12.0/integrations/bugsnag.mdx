...
Вставьте свой токен авторизации в панель управления OpenReplay в разделе «Настройки> Интеграция» и выберите проект, который вы хотите отслеживать из списка выпадающего списка.
