...
MetaDescription: "Как интегрировать CloudWatch с OpenReplay и просматривать ошибки бэкенда вместе с реплеями сессий."
---

Как интегрировать CloudWatch с OpenReplay и просматривать ошибки бэкенда вместе с реплеями сессий.
...
Для того, чтобы OpenReplay связал запись журнала Cloudwatch с записанной пользовательской сессией, должен быть распространен уникальный токен во время каждой ошибки бэкенда, которую вы хотите отслеживать.
