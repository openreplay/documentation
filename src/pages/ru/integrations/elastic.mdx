...
Для того, чтобы OpenReplay связал запись журнала Elasticsearch с записанным сеансом пользователя, необходимо распространить уникальный токен в качестве части каждой ошибки бэкэнда, ко
```python
import sys
import traceback
#...
