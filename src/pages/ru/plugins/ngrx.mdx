...
Этот плагин позволяет захватывать действия / состояние NgRx и просматривать их позже при воспроизведении записей сеансов. Это очень полезно для понимания и устранения проблем.
...
Добавьте сгенерированный мета-редьюсер в свои «импорты». Подробнее см. В документации NgRx (https://ngrx.io/guide/store/metareducers).
