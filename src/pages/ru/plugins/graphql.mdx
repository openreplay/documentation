...
<Aside type="tip">
У нас также есть подробное руководство по использованию плагина GraphQL для захвата и изменения запросов, вы можете посмотреть его [здесь](/tutorials/graphql).
</Aside>
...
Для [Apollo](https://www.apollographql.com/) вам нужно создать новую «ApolloLink» с вызовом «recordGraphQL» и поместить ее в цепочку. Вот пример того, как это сделать.
