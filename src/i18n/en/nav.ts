  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { text: { en: 'Analytics', fr: 'Analytique', es: 'Analítica', ru: 'Аналитика', zh: '分析', 'ar-ae': 'التحليلات' }, slug: 'ios-sdk/analytics', children: [] },
    ...
    },
    {
      ...
      children: [
        ...
        { text: { en: 'Analytics', fr: 'Analytique', es: 'Analítica', ru: 'Аналитика', zh: '分析', 'ar-ae': 'التحليلات' }, slug: 'android-sdk/analytics', children: [] },
    ...
    },
    {
      ...
      children: [
        ...
        { text: { en: 'Analytics', fr: 'Analytique', es: 'Analítica', ru: 'Аналитика', zh: '分析', 'ar-ae': 'التحليلات' }, slug: 'rn-sdk/analytics', children: [] },
