...
If you would like to go further in configuring the tracker, check [JavaScript SDK](/installing-or/javascript-sdk#options) for the list of available options.
...
- [Upload Source-Maps](/installing-or/upload-sourcemaps): See the source code context obtained from stack traces in their original form.
